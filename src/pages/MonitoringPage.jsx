...
export default function MonitoringPage() {
  ...
  const onAddTile = () => alert("타일 추가(추후 구현)");

  return (
    <div style={{ padding: 16 }}>
      <h1 style={{ fontSize: 20, fontWeight: 600, marginBottom: 16 }}>모니터링</h1>
      ...
      >
        ...
        >
          {tiles.map(t => (
            <div key={t.id} style={{ width: 160, height: 144 }}>
              <SensorCard item={t} />
            </div>
          ))}
        ...
        {showAlert && (
          ...
          >
            ...
            <button
              onClick={() => (/* 숨김 */ (document.activeElement.blur(), null), setShowAlert(false))}
              style={{
                marginTop: 8,
                fontSize: 12,
                padding: "6px 10px",
